...
public class BakingAppWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setRemoteAdapter(R.id.ingredients_container, serviceIntent);
        views.setOnClickPendingIntent(R.layout.baking_app_widget, pendingIntent);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        appWidgetManager.notifyAppWidgetViewDataChanged(appWidgetIds, R.id.ingredients_container);
